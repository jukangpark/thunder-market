...
const BannerImg = styled.div`
  ...
  display: block;
  z-index: 0;
  background-image: url("https://m.bunjang.co.kr/pc-static/media/appdownload-banner.75b0fd5a.png");
